...
df = pd.read_csv('/Users/vaseemali/Desktop/pdb_data_no_dups.csv').merge(pd.read_csv('/Users/vaseemali/Desktop/pdb_data_seq.csv'), how='inner', on='structureId')
# Drop rows with missing labels‎⁨Macintosh HD⁩ ▸ ⁨Users⁩ ▸ ⁨vaseemali⁩ ▸ ⁨Desktop⁩
